                    ...
                    if (isCanceled) {
                        ...
                        if (recodeTime < MIN_RECORD_TIME) {
                            ...
                            try {
                                ...
                                message.what = 0x2346;
                                message.obj = mAudioRecorder.getFilePath();
                                MainActivity.clientThread.revHanlder.sendMessage(message);

                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                            Msg msg=new Msg(recodeTime,mAudioRecorder.getFilePath(),Msg.TYPE_SENT,Msg.MESSAGE_TYPE_AUDIO);

                            MainActivity.msgList.add(msg);
                            //Toast.makeText(getContext(),"zhengchang",Toast.LENGTH_SHORT).show();
